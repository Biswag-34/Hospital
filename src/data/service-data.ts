...
export const SERVICES: Service[] = [
      ...
      title: "Rural Primary Care & Community Health Services",
      icon: Stethoscope,
      summary:
        "Accessible, continuous rural healthcare built around prevention, early detection, and primary treatment—delivered through community clinics, outreach camps, and strong referral linkages for underserved villages.",
      subServices: [
        {
          title: "Primary Care OPD & Essential Treatment",
          points: [
            "General OPD for acute illnesses and common infections",
            "Basic diagnostics and first-line treatment support",
            "Management of fever, respiratory, GI and seasonal diseases",
            "Referral coordination for cases needing higher-level care",
          ],
        },
        {
          title: "Maternal, Child & Family Health",
          points: [
            "Antenatal and postnatal checkups with counseling",
            "Child growth monitoring and nutrition guidance",
            "Immunization awareness and follow-up support",
            "Women’s health support and anemia screening",
          ],
        },
        {
          title: "Chronic Disease Screening & Follow-up",
          points: [
            "Screening for diabetes, hypertension and lifestyle risks",
            "Regular follow-up and medication adherence support",
            "Health education for diet, exercise and prevention",
            "Early detection of complications and timely referrals",
          ],
        },
        {
          title: "Community Outreach & Preventive Health",
          points: [
            "Village-level health camps and awareness sessions",
            "Hygiene, sanitation and safe drinking water education",
            "School health programs and adolescent health guidance",
            "Tracking and continuity support for high-risk families",
          ],
        },
      ],
      commitmentShort:
        "Reliable rural healthcare with prevention, follow-up and referral support—so care continues beyond a single visit.",
      image: "/services/rural-healthcare.jpg",
      ctaLabel: "Book Rural OPD",
      ctaHref: "/contact",
    },

    {
      id: "disability-core",
      label: "Disability Core",
      title: "Disability & Rehabilitation (Core Services)",
      icon: Accessibility,
      summary:
        "Disability-first rehabilitation with a holistic continuum of care—combining therapy, mental health support, de-addiction care, and assistive solutions to restore function, dignity, and independence.",
      subServices: [
        {
          title: "Disability Rehabilitation & Physiotherapy",
          points: [
            "Neuro and ortho rehabilitation for functional recovery",
            "Pain management and mobility improvement programs",
            "Post-injury and post-surgery rehabilitation support",
            "Home exercise plans and caregiver-guided therapy routines",
          ],
        },
        {
          ...
          points: [
            ...
            "Community psychiatry support and follow-up guidance",
            "Family counseling and caregiver mental health support",
            "Early identification and referral for severe conditions",
          ],
        },
        {
          title: "De-addiction & Substance Abuse Treatment",
          points: [
            "Counseling and structured recovery planning",
            "Relapse prevention and long-term follow-up support",
            "Family engagement and community reintegration guidance",
            "Referral linkages for detox and higher-level services when needed",
          ],
        },
        {
          title: "Assistive Technology & Adaptive Support",
          points: [
            "Assessment for mobility aids and assistive devices",
            "Gait training and safe usage training for assistive tools",
            "Support for orthotics/prosthetics referrals and fitting coordination",
            "Functional independence training for daily living activities",
          ],
        },
      ],
      commitmentShort:
        "Holistic disability care that supports recovery, independence and dignity—through therapy, mental health, and practical assistive solutions.",
      image: "/services/disability-core.jpg",
      ctaLabel: "Book Rehab Support",
      ctaHref: "/contact",
    },
